...
export default function EditContent() {
  ...
  const fetchContent = async () => {
    try {
      ...
      switch (contentType) {
        case 'blog':
          endpoint = `/api/admin/blog/${contentId}`;
          break;
        case 'case-studies':
          endpoint = `/api/admin/casestudies/${contentId}`;
          break;
        case 'events':
          endpoint = `/api/admin/events/${contentId}`;
          break;
      }
      ...
      if (response.ok) {
        ...
        switch (contentType) {
          case 'blog':
            ...
            setImagePreview(data.image || '/api/placeholder/600/400');
            break;
          case 'case-studies':
      ...
      switch (contentType) {
        case 'blog':
          ...
          payload = {
            ...
            readTime,
            category,
            image: image || imagePreview || '/api/placeholder/600/400', // Use actual image URL
            published,
            featured,
          };
          break;
  ...
  const getPageTitle = () => {
    switch (contentType) {
      case 'blog': return 'Edit Blog Post';
      case 'case-studies': return 'Edit Case Study';
  ...
  const getPageDescription = () => {
    switch (contentType) {
      case 'blog': return 'Edit an existing blog post';
      case 'case-studies': return 'Edit an existing case study';
      case 'events': return 'Edit an existing event';
      default: return 'Edit content';
    }
  };
